...
**Status**: implemented · **Source change**: reports · **Created**: 2026-06-26 · **Promoted**: 2026-06-27 (sdd-sync, after 4 slice PRs merged on develop via #76/#79/#80/#85 + fixes via #81/#82)
...
> Canonical spec for the `reports` capability. It operationalizes
> the `reports` proposal v1 (2026-06-26). The spec declares
...
> contract requires.
>
> This is the **canonical spec** for the `reports` capability,
> promoted from the change-folder delta on 2026-06-27 by the
> `sdd-sync` phase of the `reports` change (see
> `openspec/changes/reports/sync-report.md`). The delta copy is
> kept in lockstep at
> `openspec/changes/reports/specs/reports/spec.md` as the
> audit-trail; the canonical at `openspec/specs/reports/spec.md`
> is the source of truth. The Spanish mirror lives at
> `Documents-es/openspec/specs/reports/spec.md`.
