...
**Status**: active · **Created**: 2026-06-21 · **Last sync**: 2026-06-22 (fx-cache PR-3)
...
>
> This is the canonical `fx` capability spec, promoted from
> `openspec/changes/fx-cache/specs/fx/spec.md` by the PR-3
> archive step (2026-06-22). The change folder is now at
