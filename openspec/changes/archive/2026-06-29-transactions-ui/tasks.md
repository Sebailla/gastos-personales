...
**Status**: slices 1..6 implemented · 81/83 tasks done · 2 tasks `pending (user-owned)` (T-UI-505 Lighthouse sweep, T-UI-506 manual QA sign-off) — do NOT block archive per slice 6 design §16.6 and orchestrator brief · **Implemented**: 2026-06-28 (slices 1–4) → 2026-06-29 (slices 5–6 + 4R cleanup) · **Archived**: 2026-06-29 (sdd-archive after PR #104) · **Created**: 2026-06-27
...
lg,full}`), elevation (`--ui-shadow-sm (or -md, -lg)`),
    typography scale (`--ui-text-xs (or -sm, -base, -lg, -xl, -2xl, -3xl)` - `--ui-font-normal (or -medium, -semibold, -bold)`).
