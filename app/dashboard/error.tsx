 ...
 * transactions error boundary shape (PageContainer + Card +
 ...
 * segment on the server (re-running the parallel `Promise.all`
 * fetch in `app/dashboard/page.tsx`). If the underlying error
 * was transient, the page comes back.
 *
 * Accessibility:
 ...
 *   keyboard-focusable.
 *
 * Spanish copy per the dashboard segment's locale.
 */
...
export function DashboardError({ error, reset }: DashboardErrorProps): React.JSX.Element {
  useEffect(() => {
