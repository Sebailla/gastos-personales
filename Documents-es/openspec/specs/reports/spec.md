...
**Estado**: implementado · **Cambio fuente**: reports · **Creado**: 2026-06-26 · **Promovido**: 2026-06-27 (sdd-sync, después de 4 PRs de slice mergeados en develop vía #76/#79/#80/#85 + fixes vía #81/#82)
...
> Especificación canónica de la capability `reports`.
> Operationaliza la propuesta de `reports` v1 (2026-06-26). La
> spec declara **qué debe ser verdadero** después de que el
> cambio aterrice, no cómo implementarlo. Los detalles de
> implementación (rutas de archivos, sintaxis del schema, layout
> de tests) se limitan a lo que requiere el contrato
> cross-module.
>
> Esta es la **especificación canónica** de la capability
> `reports`, promovida desde la delta en la carpeta del cambio
> el 2026-06-27 por la fase `sdd-sync` del cambio `reports`
> (ver `openspec/changes/reports/sync-report.md`). La copia delta
> se mantiene en lockstep en
> `openspec/changes/reports/specs/reports/spec.md` como
> audit-trail; la canónica en `openspec/specs/reports/spec.md`
