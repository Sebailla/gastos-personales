...
>
> Esta es una **delta spec** para la nueva capability
> `transactions`. La capability `transactions` todavía no existe
> bajo `openspec/specs/` — vive bajo
> `openspec/changes/transactions/specs/transactions/` hasta que
